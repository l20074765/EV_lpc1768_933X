...
#define CS_SET()     	FIO1DIR |= (1ul << 25); FIO1SET |= (1ul << 25)	   //串行选通
#define CS_CLR()     	FIO1DIR |= (1ul << 25); FIO1CLR |= (1ul << 25)
#define SID_SET()    	FIO1DIR |= (1ul << 26); FIO1SET |= (1ul << 26)    //串行数据
#define SID_CLR()    	FIO1DIR |= (1ul << 26); FIO1CLR |= (1ul << 26) 
#define SCLK_SET()   	FIO2DIR |= (1ul << 8);  FIO2SET |= (1ul << 8)    //串行时钟,下半屏
#define SCLK_CLR()   	FIO2DIR |= (1ul << 8);  FIO2CLR |= (1ul << 8)
#define SCLK_SET_Up()   FIO1DIR |= (1ul << 24); FIO1SET |= (1ul << 24)    //串行时钟,上半屏
